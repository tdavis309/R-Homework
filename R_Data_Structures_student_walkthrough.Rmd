...
```{r}
vector_1 <- c(1,2,3)
vevtor_2 <- c(4,5,6,7,8,9)
vector_add <- vector_1 + vector_2
vector_add

#vector 1 is repeated to make c(1,2,3,1,2,3)
```
...
#create a dataframe from these 3 vectors, each vector is its own column
...
combined_vec <-  c(first_vector, second_vector)

my_arr <- array(
  combined_vec, dim <- c(3,3,2))
my_arr
